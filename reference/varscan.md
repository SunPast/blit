...
VarScan is a platform-independent software tool developed at the Genome
Institute at Washington University to detect variants in NGS data.
...
- ...:
  ...
  Additional arguments passed to `varscan` command. Empty arguments are
